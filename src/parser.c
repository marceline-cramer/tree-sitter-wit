...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2), SHIFT_REPEAT(143),
  ...
  [328] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fields_repeat1, 2), SHIFT_REPEAT(119),
  ...
  [393] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variant_items_repeat1, 2), SHIFT_REPEAT(129),
  ...
  [404] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_flags_repeat1, 2), SHIFT_REPEAT(144),
  ...
  [455] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_item, 3, .production_id = 6),
  ...
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_payload, 3),
  ...
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 2),
  ...
  [509] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 3),
  [511] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input, 1),
  ...
  [525] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 4),
